<?php
/**
 * Conversations Made Possible Customizer functionality
 *
 * @package WordPress
 ...
 */
function conversationsmp_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'conversationsmp_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'conversationsmp' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => conversationsmp_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'conversationsmp' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'conversationsmp' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'conversationsmp' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'conversationsmp' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'conversationsmp' );
}
add_action( 'customize_register', 'conversationsmp_customize_register', 11 );

/**
 * Register color schemes for Conversations Made Possible.
 *
 * Can be filtered with {@see 'conversationsmp_color_schemes'}.
 *
 ...
 */
function conversationsmp_get_color_schemes() {
	return apply_filters( 'conversationsmp_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'conversationsmp' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
		...
		'yellow'  => array(
			'label'  => __( 'Yellow', 'conversationsmp' ),
			'colors' => array(
				'#f4ca16',
				'#ffdf00',
				'#ffffff',
		...
		'purple'  => array(
			'label'  => __( 'Purple', 'conversationsmp' ),
			'colors' => array(
				'#674970',
				'#2e2256',
				'#ffffff',
...
if ( ! function_exists( 'conversationsmp_get_color_scheme' ) ) :
/**
 * Get the current Conversations Made Possible color scheme.
 *
 * @since Conversations Made Possible 1.0
 *
 * @return array An associative array of either the current or default color scheme hex values.
 */
function conversationsmp_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = conversationsmp_get_color_schemes();
...
endif; // conversationsmp_get_color_scheme

if ( ! function_exists( 'conversationsmp_get_color_scheme_choices' ) ) :
/**
 * Returns an array of color scheme choices registered for Conversations Made Possible.
 *
 * @since Conversations Made Possible 1.0
 *
 * @return array Array of color schemes.
 */
function conversationsmp_get_color_scheme_choices() {
	$color_schemes                = conversationsmp_get_color_schemes();
...
endif; // conversationsmp_get_color_scheme_choices

if ( ! function_exists( 'conversationsmp_sanitize_color_scheme' ) ) :
/**
 ...
 */
function conversationsmp_sanitize_color_scheme( $value ) {
	$color_schemes = conversationsmp_get_color_scheme_choices();
...
endif; // conversationsmp_sanitize_color_scheme
...
add_action( 'wp_enqueue_scripts', 'conversationsmp_color_scheme_css' );
 ...
 * @since Conversations Made Possible 1.0
 */
function conversationsmp_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', conversationsmp_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'conversationsmp_customize_control_js' );
 ...
 * @since Conversations Made Possible 1.0
 */
function conversationsmp_customize_preview_js() {
	wp_enqueue_script( 'conversationsmp-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'conversationsmp_customize_preview_js' );
 ...
 */
function conversationsmp_get_color_scheme_css( $colors ) {
 ...
 * @since Conversations Made Possible 1.0
 */
function conversationsmp_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-conversationsmp-color-scheme">
		<?php echo conversationsmp_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'conversationsmp_color_scheme_css_template' );
